    ...
    <div className="min-h-screen bg-neutral-50 flex flex-col p-5">
      <div className="w-full flex gap-20 items-center mb-6">
        <div className="text-black text-2xl font-semibold font-['Roboto']">Manage Organization</div>
          <button className="px-4 py-2 bg-sky-500 text-gray-50 text-sm font-semibold rounded-lg">Tambah Organisasi</button>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-lg border border-gray-200 flex flex-col">
            <p className="text-zinc-500 text-xs pb-1">Jumlah Organisasi</p>
              <div className="flex justify-between items-center w-full">
                <p className="text-zinc-900 text-xl font-semibold">6 Organisasi</p>
            ...
            <div className="w-full h-auto md:h-[102px] px-6 py-4 flex flex-col md:flex-row justify-between items-center">
              <div className="flex-col justify-start items-start gap-2">
                <div className="text-black text-2xl md:text-[32px] font-bold leading-10 pb-2">Data Organisasi</div>
                <div className="text-zinc-900/opacity-40 text-base font-normal">Custom data Organisasi</div>
              </div>
                  ...
                  <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td className="px-6 py-4">Kesalahan Maratuas Indonesia</td>
                        <td className="px-6 py-4">29 Mei 2024</td>
                        <td className="px-6 py-4">@sosialmediaclimate</td>
