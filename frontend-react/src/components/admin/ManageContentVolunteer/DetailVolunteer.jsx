        ...
        <div className="bg-transparent">
            {[
              { 
                ...
                pendaftar: '30',
                target: '50',
                deskripsi: 'Program "Ayo Menjadi Kakak SabangMerauke" adalah inisiatif dari Yayasan SabangMerauke yang bertujuan untuk memperkuat rasa persatuan dan kesaruab bangsa melalui....'
              },
            ].map((item, index) => (
