...
const TabelDataOrganisasi = () => {
    const data = [
      {
        no: 1,
        namaOrganisasi: "Kalasahan Maratua Indonesia",
        tanggalBergabung: "29 Mei 2024",
        kontak: "@sosialmediaclimate",
        status: "selesai",
      },
      {
        no: 2,
          ...
          <tbody>
            {data.map((item, index) => (
              <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td className="px-6 py-4">{item.tanggalBergabung}</td>
