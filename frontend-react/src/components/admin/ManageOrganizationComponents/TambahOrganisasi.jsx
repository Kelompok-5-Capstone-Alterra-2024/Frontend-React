                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="grid grid-rows-1 md:grid-rows-6 gap-4">
                                <div className="flex flex-col sm:flex-row items-center">
                                    ...
                                    <span className="p-2 text-gray-900 font-semibold text-center border border-gray-300 w-full rounded-b-lg sm:rounded-b-none sm:rounded-r-lg sm:w-auto sm:mt-0 sm:flex-1" id="file_name">Masukan Logo</span>
                                    <input
                                        className="hidden"
                                        id="multiple_files"
                                        type="file"
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="organisasi" className="block text-gray-700 text-sm font-normal">Nama Organisasi</label>
                                    <input type="text" id="organisasi" placeholder="Masukkan Nama Organisasi" className="mt-1 h-12 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                                </div>
                                <div className="flex flex-col">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <input type="text" id="website" placeholder="Website Organisasi" className="mt-1 h-12 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                                </div>
                                <div className="flex flex-col">
                                    <label htmlFor="instagram" className="block text-gray-700 text-sm font-normal">Instagram</label>
                                    <input type="text" id="instagram" placeholder="Kontak Organisasi" className="mt-1 h-12 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                                </div>
                                <div className="flex flex-col">
                                    <label htmlFor="website" className="block text-gray-700 text-sm font-normal">No Rekening</label>
                                    <input type="text" id="website" placeholder="No Rekening" className="mt-1 h-12 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                                </div>
                            </div>
                            <div className="flex flex-col">
