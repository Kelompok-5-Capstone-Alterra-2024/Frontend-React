...
const RiwayatTransaksi = () => {
  ...
  const getAllTransactionHistory = async (page) => {
    try {
      const response = await fetch(`https://capstone-alterra-424313.as.r.appspot.com/api/v1/admin/transactions-history?page=${page}&limit=10`, {
        headers: {
